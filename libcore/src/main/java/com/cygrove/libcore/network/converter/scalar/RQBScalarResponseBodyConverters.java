package com.cygrove.libcore.network.converter.scalar;
    ...
    static final class StringResponseBodyConverter implements Converter<ResponseBody, String> {
        ...
        public String convert(ResponseBody value) throws IOException {
            ...
            try {
                ...
                if (httpStatus.getCode().equals("SYS-APP-002")) {
                    value.close();
                    throw new ApiException(httpStatus.getMessage(), httpStatus.getCode());
                }
